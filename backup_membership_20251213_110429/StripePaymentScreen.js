 ...
 */
const PaymentForm = ({ paymentData, planDetails, onSuccess, onError, initialClientSecret, initialPaymentIntentId }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const confirmData = {
        ...
        user_id: "458" ?? paymentData.userId,
        plan_id: paymentData.plan_id,
        hours: paymentData.hours || 0,
      };
...
const StripePaymentScreen = () => {
  ...
  const { paymentData, userId, planDetails, clientSecret, paymentIntentId } = route.params || {};
