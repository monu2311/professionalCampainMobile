    ...
    <>
      <View style={[styles.container, style]}>
        ...
        <View style={inputContainerStyle}>
          <Dropdown
            style={inputStyle}
            placeholderStyle={[defaultStyles.placeholderStyle, { textAlign: getTextAlign(isRTL) }]}
            selectedTextStyle={[defaultStyles.placeholderStyle, { textAlign: getTextAlign(isRTL) }]}
        ...
        {meta.touched && meta.error && (
          <Text style={[defaultStyles.errorText, { textAlign: getTextAlign(isRTL) }]}>{meta.error}</Text>
        )}
      </View>
    </>
  );
