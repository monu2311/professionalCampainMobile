      ...
      <Card
        ...
        {step === 0 && (
          <View
            ...
            <Text style={heading}>{t('screens:profile.final.title', { defaultValue: 'Finish' })}</Text>
            <Text
              style={{...defaultStyles.placeholderStyle, color: COLORS.black, textAlign: 'center', writingDirection: getWritingDirection(isRTL)}}>
              {t('screens:profile.final.stepCounter', { defaultValue: 'Step 6 of 6' })}
            </Text>
          </View>
        )}
        <View
          ...
          <Text style={heading1}>
            {step === 0
              ? t('screens:profile.submit.title')
              : t('screens:profile.final.pendingReview')}
          </Text>
          ...
          <Text
            ...
            {t('screens:profile.submit.approvalMessage')}
          </Text>
          <Text
            style={{
              ...defaultStyles.placeholderStyle,
            ...
            {t('screens:profile.submit.editabilityMessage')}
          </Text>
          {(step == 0 || step == 1) && (
            <ButtonWrapper
              label={t('screens:profile.submit.submit')}
              onClick={() => {
