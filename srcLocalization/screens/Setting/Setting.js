...
// Enhanced settings data with icons and descriptions - using translation keys
const getEnhancedSettingsData = (t) => [
  {
    id: 1,
    label: t('screens:settings.etiquette'),
    navigation: 'AdvertisingRate',
    icon: 'star',
    description: t('screens:settings.etiquette_description'),
    color: '#FF6B6B',
  },
  {
    id: 2,
    label: t('screens:settings.help_support'),
    navigation: 'AboutUs',
    icon: 'help',
    description: t('screens:settings.help_support_description'),
    color: '#4ECDC4',
  },
  {
    id: 3,
    label: t('screens:settings.enquiries'),
    navigation: 'Enquriries',
    icon: 'contact-support',
    description: t('screens:settings.enquiries_description'),
    color: '#45B7D1',
  },
  {
    id: 4,
    label: t('screens:settings.change_password'),
        ...
        <View style={styles.profileContent}>
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>
              {profileData?.profile_name || t('common:user_name')}
            </Text>
            <Text style={styles.profileEmail}>
              {profileData?.email || t('common:user_email_placeholder')}
            </Text>
            <View style={styles.statusContainer}>
              <Icon name="verified" size={16} color={COLORS.white} />
              <Text style={styles.statusText}>{t('screens:settings.premium_member')}</Text>
            </View>
          </View>
...
const Setting = () => {
  ...
  // Get translated settings data
  const enhancedSettingsData = getEnhancedSettingsData(t);
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Animated.View style={styles.titleContainer}>
          <Text style={styles.sectionTitle}>{t('screens:settings.title')}</Text>
        ...
        <Animated.View style={styles.footer}>
          <Text style={styles.footerText}>
            {t('screens:settings.app_name')}
          </Text>
          <Text style={styles.versionText}>{t('screens:settings.version', { version: '1.0.0' })}</Text>
        </Animated.View>
      </Animated.ScrollView>
    </View>
  );
