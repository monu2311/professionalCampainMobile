      ...
      >
        ...
        <View style={{flex:1,justifyContent:'center',alignItems:'center',paddingBottom:PADDING.small}}>
          <View
            ...
            <Text style={{...defaultStyles.header,color:COLORS.specialTextColor,fontSize:26}}>{t('screens:getStarted.title')}</Text>
            <Text style={{...defaultStyles.header,marginBottom:PADDING.extralarge,color:COLORS.specialTextColor,fontSize:26}}>{t('screens:getStarted.subtitle')}</Text>
            <GradientButton
              label={t('screens:getStarted.getStartedButton')}
              onClick={()=>nextHandler("PleaseSelect")}
              length={WIDTH * 0.6}
            />
            <OutlinedButton
              label={t('screens:getStarted.alreadyHaveAccount')}
        ...
        <View
            ...
            <Text
              ...
              {t('screens:getStarted.termsText')}
            </Text>
          </View>
      </KeyboardAvoidingScrollView>
    </SafeAreaView>
