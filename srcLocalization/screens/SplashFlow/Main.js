...
const Main = () => {
  ...
  // Translation hook
  const { t } = useTranslation([NAMESPACES.SCREENS, NAMESPACES.COMMON, NAMESPACES.FORMS, NAMESPACES.STATIC]);
  ...
  const handleViewProfile = async (profile) => {
    try {
      ...
      showErrorMessage(
        t('common:errors.navigation'),
        t('common:errors.profileLoad')
      );
    }
  };
  ...
  const handleBookmarkToggle = (profile) => {
    ...
    if (newBookmarks.has(profileId)) {
      ...
      showSuccessMessage(t('common:bookmarks.removed'), '');
    } else {
      newBookmarks.add(profileId);
      showSuccessMessage(t('common:bookmarks.added'), '');
    }
    ...
    <View style={styles.emptyStateContainer}>
      {highlistData?.isLoading ? (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>{t('screens:main.loading')}</Text>
        </View>
      ) : (
        <Nodatafound />
      )}
        ...
        <View style={styles.headerContent}>
          <View style={styles.locationContainer}>
            ...
            <Text style={styles.locationText}>
              {filter.suburbs || t('screens:main.allLocations')}
            </Text>
          </View>
          <Text style={styles.countText}>
            {highlistData?.data?.escort?.length || 0} {t('screens:main.active')}
          </Text>
        </View>
      </Animated.View>
        ...
        <>
          ...
          >
              ...
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>{t('screens:main.filters')}</Text>
                  ...
                  {() => (
                    <>
                      ...
                      <View style={styles.filterSection}>
                        <Text style={styles.filterSectionTitle}>{t('screens:main.location')}</Text>
                        <CustomDropdown
                      ...
                      {/* Category Filter */}
                      <View style={styles.filterSection}>
                        <Text style={styles.filterSectionTitle}>{t('screens:main.category')}</Text>
                        <CustomDropdown
                          placeholder={t('forms:placeholders.allCategories')}
                      ...
                      {/* Quick Filters */}
                      <View style={styles.filterSection}>
                        <Text style={styles.filterSectionTitle}>{t('screens:main.availability')}</Text>
                        <View style={styles.chipContainer}>
                          ...
                          >
                            ...
                            ]}>{t('static:availability.availableNow')}</Text>
                          </TouchableOpacity>
                          ...
                          >
                            ...
                            ]}>{t('static:availability.availableToday')}</Text>
                          </TouchableOpacity>
                          ...
                          >
                            ...
                            ]}>{t('static:membership.vipMembers')}</Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    </>
              ...
              <View style={styles.modalFooter}>
                ...
                >
                  <Text style={styles.clearButtonText}>{t('common:actions.clearAll')}</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.applyButton}
                  onPress={applyFilters}
                >
                  <Text style={styles.applyButtonText}>{t('common:actions.applyFilters')}</Text>
                </TouchableOpacity>
              </View>
          </Animated.View>
        </>
